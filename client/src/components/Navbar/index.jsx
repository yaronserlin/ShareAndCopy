...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg fixed-top glass-panel border-0 border-bottom border-secondary border-opacity-10 navbar-custom">
                ...
                <div className="d-flex gap-2 align-items-center">
                    {token ? (
                        ...
                        <>
                            ...
                            <Link to="/register" className="btn btn-primary rounded-pill px-3 fw-bold btn-sm btn-gradient-primary">
